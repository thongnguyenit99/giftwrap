...
{
	const CACHE_TAG = 'team1_giftwrapslider_giftwrap';
	protected $_cacheTag = 'team1_giftwrapslider_giftwrap';
	...
	{
		$this->_init('Team1\GiftwrapSlider\Model\ResourceModel\Giftwrap');
	}
