...
namespace Team1\GiftwrapSlider\Block\Sales\Invoice;
...
class Giftmessage extends \Magento\Framework\View\Element\Template
{
    ...
    {
        return $this->getInvoice()->getData('giftmessage');
    }
    ...
    {
        $giftwrapName = $this->getInvoice()->getData('giftwrap_name');
    ...
    {
        return $this->getInvoice()->getData('hide_price');
    }
}
